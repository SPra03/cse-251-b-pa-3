from model_experiment_5a import *
import time
...
fcn_model = Model_5A(n_class=n_class)
...
#             exit()
    ...
    plots(trainEpochLoss, trainEpochAccuracy, trainEpochIOU, valEpochLoss, valEpochAccuracy, valEpochIOU, best_iter, saveLocation="custom_5a/")
